 ...
 * @author Salma
 */
public class ViewMyCourses implements ActionListener {
    ...
    public ViewMyCourses(int id) {
        ...
        title = new TitleLbl("View Courses");
        ...
        Panel.add(back);
        back.addMouseListener(new UI.BackListener(TeacherId, back, RoleT, f));
        ...
        courseCb = new JComboBox(CoursesDao.getMyCourses(TeacherId));
//        co = CoursesDao.getArrayofTeacherCourses(TeacherId);
//        //Object[] coo = co.toArray();
...
//        }
        ...
        courseCb.setBounds(250, 10, 400, 28);
